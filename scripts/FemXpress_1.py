...
### check format of each merged_base_count.txt
#sgtxt_list = []
#all_path(inter_base_dir,'-1_merged_base_count.txt')
#count_files=sgtxt_list
#for count_file in count_files:
#    df = open(inter_base_dir+'/'+count_file,'r')
#    for i in df:
#        j=i
#        i=i.split('\t')
#        if i[1].strip('\n') == '':
#            print(count_file[:18]+'\t'+i[1])
#        else:
#            print('checked, OK!')
...
#df = open(result_dir+'/result_matrix1.csv','r')
#df = data_t1
...
#csv_path = result_dir+'/result_matrix1.csv'
