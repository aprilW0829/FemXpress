...
def get_each_snp_ACGT_count_for_each_barcode(bam_files, bed_file, genome):
    ...
    for bam_file in bam_files:
        ...
        barcode = bam_file[:-4]
        base_count_file = inter_base_dir + '/' + barcode + '_base_count.txt'
...
def runpipeline(a):
    ...
    print('length of split bams is '+str(len(sgtxt_list)))
    for i in sgtxt_list:
    ...
    bed_file = tmp_dir + '/filtered_freebayes_snps_manual_info.txt'
    bed_file2 = tmp_dir+'/filtered_freebayes_snps.bed'
    print('length of analysed split bams is '+str(len(bam_files)))
    base_count_files = get_each_snp_ACGT_count_for_each_barcode(bam_files, bed_file, genome)
    print('length of ACGT count file for bams is '+str(len(base_count_files)))
    ...
    print('length of analysed base_count files is '+str(len(count_files)))
